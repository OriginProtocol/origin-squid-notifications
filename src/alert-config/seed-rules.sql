-- Seed data for alert_rule table
-- Generated from current hardcoded notification processors
-- Generated at: 2026-03-09T22:55:11.867Z

BEGIN;

-- Lido ARM Pendle SY (chain 1)
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'lido-arm-pendle-sy',
  1,
  'event'::match_type,
...
-- OETH Error Trace (chain 1) [trace]
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'oeth-error-trace-trace',
  1,
  'trace'::match_type,
...
-- OETH Vault Mint (chain 1) - split out for amount filtering
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'oeth-vault-mint',
  1,
  'event'::match_type,
  ARRAY['0x39254033945aa2e4809cc2977e7087bee48bd7ab'],
  ARRAY['0x0f6798a560793a54c3bcfe86a93cde1e73087d944c0ea20544137d4121396885'],
  NULL,
  NULL,
  NULL,
  NULL,
  '{"field": "_value", "op": "gte", "value": "100000000000000000"}'::jsonb,
  'OETH',
  'low'::severity_level,
  NULL,
  'OETH Vault Mint'
...
-- OGN Error Trace (chain 1) [trace]
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'ogn-error-trace-trace',
  1,
  'trace'::match_type,
...
VALUES (
  ...
  ARRAY['0x2720efa4b2dd4f3f8a347da3cbd290a522e9432da9072c5b8e6300496fdde282'],
  NULL,
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  ARRAY['0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef'],
  NULL,
  ARRAY['0x0000000000000000000000007609c88e5880e934dd3a75bcfef44e31b1badb8b'],
  NULL,
  NULL,
  NULL,
  'OGN Alerts',
...
-- OS Vault Mint (chain 146) - split out for amount filtering
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'os-vault-mint-sonic',
  146,
...
-- Sonic Error Trace (chain 146) [trace]
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'sonic-error-trace-trace-sonic',
  146,
  'trace'::match_type,
...
-- OUSD Error Trace (chain 1) [trace]
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'ousd-error-trace-trace',
  1,
  'trace'::match_type,
...
-- OUSD Vault Mint (chain 1) - split out for amount filtering
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'ousd-vault-mint',
  1,
...
-- Super OETH Base Error Trace (chain 8453) [trace]
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'super-oeth-base-error-trace-trace-base',
  8453,
  'trace'::match_type,
...
-- superOETHb Vault Mint (chain 8453) - split out for amount filtering
INSERT INTO alert_rule (id, chain_id, match_type, addresses, topic0s, topic1s, topic2s, topic3s, sighashes, data_filters, topic, severity, notify_targets, display_name)
VALUES (
  'superoethb-vault-mint-base',
  8453,
  'event'::match_type,
  ARRAY['0x98a0cbef61bd2d21435f433be4cd42b56b38cc93'],
  ARRAY['0x0f6798a560793a54c3bcfe86a93cde1e73087d944c0ea20544137d4121396885'],
