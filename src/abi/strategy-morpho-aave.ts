...
export const functions = {
    LENS: viewFun("0x18a4619a", "LENS()", {}, p.address),
    MORPHO: viewFun("0x3acb5624", "MORPHO()", {}, p.address),
    _deprecated_rewardLiquidationThreshold: viewFun("0xf817bc63", "_deprecated_rewardLiquidationThreshold()", {}, p.uint256),
    _deprecated_rewardTokenAddress: viewFun("0x2e655201", "_deprecated_rewardTokenAddress()", {}, p.address),
    ...
    getPendingRewards: viewFun("0xd9621f9e", "getPendingRewards()", {}, p.uint256),
...
export class Contract extends ContractBase {
    ...
    LENS() {
        return this.eth_call(functions.LENS, {})
    }
    ...
    _deprecated_rewardLiquidationThreshold() {
        return this.eth_call(functions._deprecated_rewardLiquidationThreshold, {})
    }

    _deprecated_rewardTokenAddress() {
        return this.eth_call(functions._deprecated_rewardTokenAddress, {})
    }
    ...
    getPendingRewards() {
        return this.eth_call(functions.getPendingRewards, {})
    }
...
/// Function types
export type LENSParams = FunctionArguments<typeof functions.LENS>
export type LENSReturn = FunctionReturn<typeof functions.LENS>
...
export type _deprecated_rewardLiquidationThresholdParams = FunctionArguments<typeof functions._deprecated_rewardLiquidationThreshold>
export type _deprecated_rewardLiquidationThresholdReturn = FunctionReturn<typeof functions._deprecated_rewardLiquidationThreshold>

export type _deprecated_rewardTokenAddressParams = FunctionArguments<typeof functions._deprecated_rewardTokenAddress>
export type _deprecated_rewardTokenAddressReturn = FunctionReturn<typeof functions._deprecated_rewardTokenAddress>
...
export type GetPendingRewardsParams = FunctionArguments<typeof functions.getPendingRewards>
export type GetPendingRewardsReturn = FunctionReturn<typeof functions.getPendingRewards>
