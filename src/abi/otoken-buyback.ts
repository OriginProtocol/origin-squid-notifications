...
export const events = {
    CVXShareBpsUpdated: event("0x620398066c59c2d8a15b84b15d6d280cd013e1e8da21405351a32970e959c787", {"bps": p.uint256}),
    ...
    OTokenBuyback: event("0x298e4dbf1f6f43b0e8cd13394bba43125c8c376005b44b664a9fd2eaaeb44743", {"oToken": indexed(p.address), "swappedFor": indexed(p.address), "swapAmountIn": p.uint256, "amountOut": p.uint256}),
    ...
    RewardsSourceUpdated: event("0x95561238de8d7836da6d15311c07a2546a1a712b477f44391ddd1e6e0556c6cd", {"_address": indexed(p.address)}),
    StrategistUpdated: event("0x869e0abd13cc3a975de7b93be3df1cb2255c802b1cead85963cc79d99f131bee", {"_address": p.address}),
    SwapRouterUpdated: event("0x36db479a3b4d3672bd6f5fca4484283f60b5ac70647b1ceec13ecbb1d030a2df", {"_address": indexed(p.address)}),
    TreasuryManagerUpdated: event("0xd16d2cf254200e4dc6dc82512e9d11673e06a798c40b90cef7583729b4f7a8d4", {"_address": indexed(p.address)}),
}

export const functions = {
    balanceForCVX: fun("0x6f2ff9e0", {}, p.uint256),
    balanceForOGN: fun("0x3551fb78", {}, p.uint256),
    claimGovernance: fun("0x5d36b190", {}, ),
    cvx: fun("0x923c1d61", {}, p.address),
    cvxLocker: fun("0x8d68f9ff", {}, p.address),
    cvxShareBps: fun("0x17cf0122", {}, p.uint256),
    governor: fun("0x0c340a24", {}, p.address),
    initialize: fun("0xf7013ef6", {"_swapRouter": p.address, "_strategistAddr": p.address, "_treasuryManagerAddr": p.address, "_rewardsSource": p.address, "_cvxShareBps": p.uint256}, ),
    isGovernor: fun("0xc7af3352", {}, p.bool),
    lockAllCVX: fun("0x113f2ec7", {}, ),
    oToken: fun("0x1a32aad6", {}, p.address),
    ogn: fun("0x602bc098", {}, p.address),
    rewardsSource: fun("0xf7240d2f", {}, p.address),
    safeApproveAllTokens: fun("0xad1728cb", {}, ),
    setCVXShareBps: fun("0x87f8b719", {"_bps": p.uint256}, ),
    setRewardsSource: fun("0xd1c76638", {"_address": p.address}, ),
    setStrategistAddr: fun("0x773540b3", {"_address": p.address}, ),
    setSwapRouter: fun("0x41273657", {"_router": p.address}, ),
    setTreasuryManager: fun("0xfe47a9f2", {"_address": p.address}, ),
    strategistAddr: fun("0x570d8e1d", {}, p.address),
    swapForCVX: fun("0xdd0a6514", {"oTokenAmount": p.uint256, "minCVX": p.uint256, "swapData": p.bytes}, ),
    swapForOGN: fun("0xbe50c839", {"oTokenAmount": p.uint256, "minOGN": p.uint256, "swapData": p.bytes}, ),
    swapRouter: fun("0xc31c9c07", {}, p.address),
    transferGovernance: fun("0xd38bfff4", {"_newGovernor": p.address}, ),
    transferToken: fun("0x1072cbea", {"token": p.address, "amount": p.uint256}, ),
    treasuryManager: fun("0x3cea70d9", {}, p.address),
    updateBuybackSplits: fun("0x75d7a6b4", {}, ),
}
